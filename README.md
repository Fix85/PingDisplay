...
- **Color-Coded Status:**
  - <span style="color:green">**Green**</span>: `0 - 80 ms` (Excellent connection)
...
- Fabric API (any build for 1.20.1)
- Java `>= 17`
...
- **Цветовое обозначение качества связи:**
  - <span style="color:green">**Зеленый**</span>: `до 80 ms` (Отличное соединение)
